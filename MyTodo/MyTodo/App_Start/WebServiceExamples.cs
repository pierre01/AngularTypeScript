...
namespace MyTodo
{
    ...
    public class TodoRepository
    {
        ...
        {
            todos.Add(new Todo { Content = "Go get me a coffee", Id = 1 });
            todos.Add(new Todo { Content = "Send the kids to school", Id = 1 });
            todos.Add(new Todo { Content = "Repair Bender", Id = 1 });
        }
